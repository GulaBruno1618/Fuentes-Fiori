		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#SolicituddeVacaciones-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SolicituddeVacaciones-display": {
								"semanticObject": "SolicituddeVacaciones",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsap.vacaciones.solicvacaciones",
									"url": sap.ui.require.toUrl("zsap/vacaciones/solicvacaciones")
								}
							}
						}
					}
